...
def load_timeseries(filepath):
    ...
    date_fin = pd.to_datetime(df_horaire.iloc[2, 103])  # CZ3
    ...
    # Puissance de la turbine d'Artouste
    power_artouste_turbine = df_horaire.iloc[9, 8:104]

    # Puissance de la turbine de Bious
    power_bious_turbine = df_horaire.iloc[11, 8:104]

    # Puissance de la turbine de Fabreges
    power_fabreges_turbine = df_horaire.iloc[12, 8:104]

    # Puissance de la turbine de Pont-de-Camps
